...
public class menus
{
	...
	public String menu0()
	{
        ...
        System.out.println("(5) Verificar cozinha");
        System.out.println("(6) Despesas");
        System.out.println("(7) relatorios");
        System.out.println("(8) receber feedback dos clientes");
        System.out.println("(9) Fechar gerenciador (os dados serao perdidos)");
        String opc;
        opc=input.nextLine();
        return opc;
	}
