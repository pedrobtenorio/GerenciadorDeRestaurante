		...
		while(pedindo)
		{
	    	...
	    	else
	    	{
				...
				for (Mesas s : mesa ) 
				{
					...
					{
						if(s.getOcupado()==false)
						{
							System.out.println("voce precisa colocar clients na mesa antes de anotar o pedido");
							return;
						}
						mesaExiste=true;
						s.setPedidos(prato);
			...
			System.out.println("se ainda deseja continuar pedindo digite 1, se nao digite qualquer tecla");
